...
function seed(db) {
  if (db.prepare('SELECT COUNT(*) AS count FROM services').get().count === 0) {
    ...
    const rows = [
      ...
      ['hairstyles', 'Прически', 'Укладки на каждый день, вечерние и свадебные прически любой сложности с использованием профессиональной косметики.', '60 мин', 'от 1800 ₽', 'services', 1, 5, '/images/catalog-hairstyles.jpg'],
