...
const sections = {
  ...
  price: { label: 'Прайс', singular: 'позицию', collection: 'price_items', description: 'Карточки услуг на странице «Услуги»: цена, описание, фото и порядок. Выберите группу, чтобы увидеть её позиции.' },
